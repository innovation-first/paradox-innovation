...
## Why Visualization is Difficult: The Failure of Linear Methods
...
{{< figure src="images/PCA_vs_TSNE_vs_UMAP.jpg" alt="PCA vs TSNE vs UMAP" class="center" >}}

This is why, in our case, PCA crushed the small tight "clusters," making theme separation impossible.

### The "Average" Approach with Geometric Centroid
...
{{< figure src="images/PCA_centroid.png" alt="PCA Centroid" class="center" >}}
...
## The Solution: UMAP for Semantic Projection
...
{{< figure src="images/UMAP.png" alt="UMAP" class="center" >}}
...
## Improving Readability with K-Means Clustering
...
{{< figure src="images/UMAP_Kmeans.png" alt="UMAP Kmeans" class="center" >}}

By coloring the 3D UMAP points according to their membership in the 8 K-Means clusters (in 1024D), the semantic map becomes not only readable, but each visual group now represents a well-defined content theme (GitLab, Architecture, Specific Technologies, etc.).

## Diagnostics: Detecting Low-Quality Chunks
...
{{< figure src="images/UMAP_centroid.png" alt="UMAP Centroid" class="center" >}}
*Dark blue is the shortest distance, yellow is the largest distance*

The Centroid perfectly detected non-textual "junk" that disrupts search, while UMAP provided the necessary clarity to validate the semantic cohesion of document groups.

## Further Reading

If you'd like to go deeper into the methods mentioned above:

- **UMAP (theory & implementation):** L. McInnes, J. Healy, J. Melville, *UMAP: Uniform Manifold Approximation and Projection for Dimension Reduction* (2018). https://arxiv.org/abs/1802.03426 and the `umap-learn` documentation https://umap-learn.readthedocs.io/
- **K-Means (original papers):** J. MacQueen, *Some Methods for Classification and Analysis of Multivariate Observations* (1967) and S. Lloyd, *Least Squares Quantization in PCM* (1982).
- **Choosing K / "Elbow" heuristic:** R. L. Thorndike, *Who belongs in the family?* (1953) for the early clustering-size heuristic, plus scikit-learn guidance on cluster evaluation metrics (silhouette, Calinski–Harabasz, Davies–Bouldin): https://scikit-learn.org/stable/modules/clustering.html#clustering-performance-evaluation
